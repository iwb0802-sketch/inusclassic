 ...
 * 수정: 모든 메뉴 버튼 링크 업데이트
 */
import { Video, MessageCircle, Star, BarChart3 } from "lucide-react";

export default function CTASection() {
  // 다이어트: 6개 → 4개 (예약하기·진행이력 삭제, 재즈/뮤지컬 사이트와 동일 패턴)
  const buttons = [
    ...
    { icon: BarChart3, label: "이너스 예약현황", href: "https://www.inusmc.co.kr/weekend-performance", external: true },
    { icon: MessageCircle, label: "카톡 상담하기", href: "https://pf.kakao.com/_wxovaM/chat", external: true },
  ];

  return (
    <section id="quickmenu" className="section-dark py-16 md:py-20">
      <div className="container max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
          {buttons.map((btn, i) => (
            <a
              ...
              className="fade-in-up group flex flex-col items-center justify-center gap-2.5 py-6 border border-[#c9a96e]/15 hover:border-[#c9a96e]/50 hover:bg-[#c9a96e]/5 transition-all duration-300"
        ...
        {/* Main CTA */}
        <div className="fade-in-up text-center mt-8" style={{ transitionDelay: "500ms" }}>
          <a
