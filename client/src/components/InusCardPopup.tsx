/**
 * InusCardPopup - 모바일 청첩장 오픈 팝업
 * 스타일: 좌측 상단 고정, 미니 버튼 + 펼침 형태
 * 하루 한 번 표시 (localStorage 기반)
 */
import { useEffect, useState } from "react";
import { X, ChevronDown, ChevronUp, Gift } from "lucide-react";

const POPUP_IMG = "/manus-storage/popup-inuscard_24bac0d2.png";
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                💌 <span className="font-medium">이너스뮤직 고객이라면</span>
                &nbsp;모바일 청첩장도{" "}
                <span style={{ color: "#5BB5A2" }} className="font-semibold">특별하게!</span>
              </p>
            </div>
          </div>
